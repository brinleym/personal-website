        ...
        <Grid item xs={12} md={6}>
          {/* <Paper className={classes.paper}> */}
            <WorkCard
              ...
              description="This is a report on the feasibility of bringing serverless compute capabilities to compute-constrained
              ...
              details="This paper was not designed to be read in its entirety. Rather, each of its six main sections are entirely
                       ...
                       section describes the evolution of the Internet and Cloud Computing. The second section defines terms (avoiding
                       marketing speak whenever possible). The third section compares the key vendors of serverless and edge computing
                       ...
                       recommendations for choosing vendors when there is a need to leverage servleress and/or edge compute as-a-service."
        ...
        <Grid item xs={12} md={6}>
          {/* <Paper className={classes.paper}> */}
            <WorkCard
              ...
              details="As the worldwide rollout of 5th Generation (5G) cellular networks picks up pace, a team of researchers decide it’s time to start 
              designing 6G. It’s an ambitious endeavor to say the least, as little is still known about what the impact of 5G will be, never mind 
              what 6G will one day look like. Though one thing is clear: in 6G, digital information will no longer be confined to our screens. 
              Whether it be through biocompatible computer chips, wearables, or self-driving cars, the world’s knowledge in our 6G future will 
              be as accessible and seamlessly integrated into our daily lives as our own thoughts. This means that our future networks must be 
              capable of transmitting vast sums of data almost instantaneously—a tall order when one considers the physical laws that will of 
              course limit how fast we can transmit information over the air. Thus, 6G will be the first network wherein ubiquitous AI will be 
              even more critical than the network architecture itself to drive the next wave of technological innovation. As the race to 6G 
              begins, one question looms large: who will take the lead in building our future?
          ...
          {/* <Paper className={classes.paper}> */}
            <WorkCard
                ...
                details="Since the average doctor's appointment lasts a mere 20 minutes, it is critical for patients to prepare for
                         ...
                         patient in mind and are thus simple and intuitive to use, making it easy for the patient to identify and clearly 
                         outline their chief concerns and questions. Click the link above to get started!"
